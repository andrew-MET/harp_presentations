...
```{r simple-wind-speed-plot, message=FALSE}
...
```{r simple-wind-speed-plot-grey-country, message=FALSE}
...
```{r grid-square-prob, message=FALSE}
...
```{r nbhd-prob-within, message=FALSE}
